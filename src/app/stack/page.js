  ...
  return (
    <div className="p-8">
      ...
      <div className="flex flex-col md:flex-row items-center gap-3 mb-12">
        <h1 className="text-4xl md:text-5xl font-bold text-gray-800">My Skills</h1>
      ...
      {/* Tech Icons Grid */}
      <div className="grid grid-cols-3 sm:grid-cols-4 p-8 md:grid-cols-6 lg:grid-cols-8 gap-6 justify-items-center">
